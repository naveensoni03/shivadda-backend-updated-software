...
# print(f"ðŸ”§ Fixing Crash (Importing Missing Icon) & Stabilizing UI in: {TARGET_FILE}")

# code_content = r"""import React, { useState, useEffect } from "react";
# import SidebarModern from "../components/SidebarModern";
# // FIXED: Added 'Server' to imports to prevent crash
# import { Globe, Plus, RefreshCw, MoreHorizontal, ChevronLeft, ChevronRight, Zap, Eye, Edit, Trash2, X, MapPin, Mail, Server } from "lucide-react";
...
#           // Removed toast on refresh to stop annoying popups
#       } catch (error) {
...
#                                                 <button onClick={(e) => { e.stopPropagation(); setViewNode(center); setActiveActionMenu(null); }} className="action-item"><Eye size={14}/> View Node</button>
#                                                 <button onClick={(e) => { e.stopPropagation(); toast.success("Edit: " + center.name); setActiveActionMenu(null); }} className="action-item"><Edit size={14}/> Edit</button>
...
#                 color: #475569; cursor: pointer; display: flex; align-items: center; gap: 8px; font-size: 0.85rem; width: 100%;
#             }
...
# print("✅ FIXED: Server Icon Crash, Pagination Visibility, and Action Buttons!")
