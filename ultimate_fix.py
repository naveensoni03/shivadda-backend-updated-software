...
print(f"🚀 Fixing Dropdown Visibility & Action Buttons in: {TARGET_FILE}")
  ...
  return (
    <div className="waoo-app-container">
                                    ...
                                    <td style={{textAlign: 'center', position: 'relative'}}>
                                        ...
                                        {activeActionMenu === center.id && (
                                            <div className="action-popup fade-in">
                                                <button onClick={() => handleAction('View', center.name)}><Eye size={14}/> View</button>
                                                <button onClick={() => handleAction('Edit', center.name)}><Edit size={14}/> Edit</button>
                                                <button onClick={() => handleAction('Delete', center.name)} className="delete"><Trash2 size={14}/> Delete</button>
                                            </div>
                                        )}
                                    </td>
                                </tr>
        ...
        <style>{`
            ...
            .premium-select option { background: #ffffff; color: #0f172a; padding: 10px; }

            .neon-id-card { background: #0f172a; border-radius: 28px; padding: 25px; color: white; position: relative; }
            ...
            .action-popup { 
                ...
                z-index: 999; display: flex; flex-direction: column; gap: 4px; min-width: 120px;
            }
            .action-popup button { 
                background: transparent; border: none; text-align: left; 
                padding: 10px 12px; border-radius: 8px; font-weight: 600; 
                color: #475569; cursor: pointer; display: flex; align-items: center; gap: 8px; 
                font-size: 0.85rem;
            }
            ...
            .p-btn { background: white; border: 1px solid #e2e8f0; padding: 8px; border-radius: 10px; cursor: pointer; }
...
print("✅ ULTIMATE FIX APPLIED: Dropdowns are visible, Action buttons now work!")
