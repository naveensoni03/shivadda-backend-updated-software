...
print(f"ðŸ”§ Moving UI Up & Reducing Spacing in: {TARGET_FILE}")
  ...
  return (
    <div className="waoo-app-container">
        ...
        <style>{`
            ...
            .waoo-view { flex: 1; padding: 25px 40px; margin-left: 280px; } /* REDUCED TOP PADDING */

            .premium-select { background: #ffffff !important; color: #0f172a !important; font-weight: 700; border: 2px solid #e2e8f0; padding: 12px; border-radius: 12px; width: 100%; }
            ...
            .waoo-hero-head { margin-bottom: 25px; display: flex; justify-content: space-between; align-items: flex-end; } /* REDUCED MARGIN */
            .waoo-dashboard { display: grid; grid-template-columns: 2fr 1fr; gap: 20px; margin-bottom: 25px; } /* REDUCED MARGIN & GAP */
            
            .glass-card { background: white; border-radius: 28px; padding: 25px; border: 1px solid #e2e8f0; }
            .deck-header { font-weight: 900; color: #0f172a; font-size: 0.8rem; letter-spacing: 1px; margin-bottom: 10px; }
            ...
            .list-top { padding: 20px 30px; display: flex; justify-content: space-between; align-items: center; } /* COMPACT PADDING */
            .waoo-main-table { width: 100%; border-collapse: collapse; }
            .waoo-main-table th { text-align: left; padding: 15px 30px; color: #475569; font-size: 0.75rem; font-weight: 800; }
            ...
            .action-item { 
                ...
                color: #334155; cursor: pointer; display: flex; align-items: center; gap: 10px; font-size: 0.85rem; width: 100%;
            }
            ...
            .edit-form-grid { display: flex; flex-direction: column; gap: 15px; }
...
print("✅ UI COMPACTED: Margins & Padding Reduced!")
