...
print(f"ðŸ”§ Upgrading to 4K Video Settings & Ultra-Clean UI: {TARGET_FILE}")

# --- 4K VIDEO & ULTRA CLEAN UI CODE ---
code_content = r"""import React, { useState, useCallback } from "react";
import SidebarModern from "../components/SidebarModern";
import { Video, Mic, MicOff, Monitor, Share2, Youtube, FileText, PhoneOff, VideoOff, Radio, UploadCloud, Cast, Layers, Settings, Users, MessageSquare, Layout, Maximize } from "lucide-react";
  ...
  return (
    <div className="virtual-space-container">
            ...
            <header className="vs-header slide-down">
                <div>
                    <h1 className="vs-title">
                        Virtual Studio <span className="pro-badge">4K PRO</span>
                        {isLive && <span className="live-badge pulse-red"><Radio size={14}/> LIVE</span>}
                    </h1>
                    <p className="vs-subtitle">Ultra-HD Streaming & Interactive Class</p>
                </div>
                ...
                <div className="video-card shadow-xl">
                    <div className="video-frame">
                        ...
                        <div className="status-tags">
                            ...
                            <span className="tag quality">4K UHD</span>
                        </div>
                    ...
                    <div className="info-card shadow-sm hover-lift">
                        ...
                        <div className="card-body">
                            <div className="list-item">
                                ...
                                <div>
                                    <span className="item-title">Physics_Ch1.pdf</span>
      ...
      <style>{`
        ...
        .vs-subtitle { color: var(--text-light); margin-top: 2px; font-size: 0.9rem; font-weight: 500; }
        ...
        /* VIDEO CARD & FRAME */
        .video-card { background: black; border-radius: 20px; overflow: hidden; height: 100%; position: relative; border: 1px solid #334155; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04); }
        .video-frame { width: 100%; height: 100%; position: relative; display: flex; alignItems: center; justifyContent: center; background: #000; }
        .webcam-feed { width: 100%; height: 100%; object-fit: cover; } /* Ensures full cover without black bars if aspect ratio matches */
        ...
        .tag.quality { background: rgba(0, 0, 0, 0.5); border: 1px solid rgba(255,255,255,0.2); }
        ...
        .ctrl-btn { width: 45px; height: 45px; border-radius: 50%; border: none; background: rgba(255,255,255,0.1); color: white; display: flex; alignItems: center; justifyContent: center; cursor: pointer; transition: all 0.2s; }
        .ctrl-btn:hover { background: rgba(255,255,255,0.2); transform: scale(1.05); }
        .ctrl-btn.is-off { background: #ef4444; color: white; }
        .ctrl-btn.is-off:hover { background: #dc2626; }
        ...
        .info-card { background: white; border-radius: 20px; border: 1px solid #f1f5f9; display: flex; flex-direction: column; }
...
print("✅ SUCCESS: VirtualSpace.jsx upgraded to 4K Video & Ultra Clean UI!")
