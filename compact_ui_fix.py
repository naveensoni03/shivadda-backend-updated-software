...
print(f"ðŸ”§ Applying COMPACT UI FIX to Locations Page in: {TARGET_FILE}")
  ...
  return (
    <div className="waoo-app-container">
                                    ...
                                    <td style={{textAlign: 'center', position: 'relative'}}>
                                        ...
                                        {activeActionMenu === center.id && (
                                            <div className="action-popup fade-in">
                                                ...
                                                <button onClick={(e) => { e.stopPropagation(); handleDelete(center.id); }} className="action-item delete"><Trash2 size={14}/> Delete</button>
                                            </div>
                                        )}
                                    </td>
                                </tr>
        ...
        <style>{`
            ...
            .action-popup { 
                position: absolute; right: 50px; top: -30px; /* Moves higher up */
                background: white; border-radius: 8px; /* Tighter radius */
                box-shadow: 0 5px 25px rgba(0,0,0,0.15); 
                border: 1px solid #e2e8f0; padding: 4px; /* Reduced padding */
                z-index: 10000; display: flex; flex-direction: column; gap: 2px; min-width: 110px; /* Reduced Width */
            }
            .action-item { 
                background: transparent; border: none; text-align: left; 
                padding: 8px 10px; /* Compact Item Padding */
                border-radius: 6px; font-weight: 700; 
                color: #475569; cursor: pointer; display: flex; align-items: center; gap: 8px; font-size: 0.75rem; width: 100%;
            }
            .action-item:hover { background: #f1f5f9; color: #0f172a; }
            .action-item.delete { color: #ef4444; border-top: 1px solid #f1f5f9; margin-top: 2px; }
...
print("✅ COMPACT UI FIX APPLIED: Small Popup, Higher Position, All Buttons Visible!")
