...
print(f"✨ BEAUTIFYING ONBOARDING FORM UI in: {TARGET_FILE}")

code_content = r"""import React, { useState, useEffect } from "react";
import SidebarModern from "../components/SidebarModern";
import { Building2, Plus, Search, MapPin, User, Mail, MoreHorizontal, Edit, Trash2, X, Phone, Eye, CheckCircle, RefreshCw } from "lucide-react";
  ...
  return (
    <div className="waoo-app-container">
        ...
        <div className="waoo-view">
            ...
            {/* --- MODALS (THE FORM UI IS UPDATED HERE) --- */}
                ...
                <div className="glass-overlay fade-in">
                    <div className="glass-modal scale-up">
                        <div className="g-modal-head">
                            {/* Title styled bigger and bolder */}
                            <h3>{viewNode ? "School Profile" : editNode ? "Update Details" : "Onboard New School"}</h3>
                        ...
                        {/* --- FORM SECTION WITH NEW UI --- */}
                        {(editNode || isAddOpen) && (
                            <div className="g-modal-body">
                                {/* Using 'waoo-form-group' for better spacing */}
        ...
        <style>{`
            ...
            /* --- EXISTING STYLES (Kept for page structure) --- */
            ...
            .waoo-search-input { border: none; flex: 1; font-size: 1rem; outline: none; color: var(--text-dark); font-weight: 500; }
            ...
            .waoo-btn-cancel {
                background: white; border: 2px solid #e2e8f0; color: var(--text-light);
                padding: 14px 24px; border-radius: 14px; font-weight: 800; font-size: 0.95rem;
                cursor: pointer; transition: 0.2s;
            }
            .waoo-btn-cancel:hover { background: #f8fafc; border-color: #cbd5e1; color: var(--text-dark); }

            .waoo-btn-primary-gradient { 
                background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%); color: white; 
                border: none; padding: 14px 28px; border-radius: 14px; font-weight: 800; font-size: 0.95rem;
                cursor: pointer; display: flex; align-items: center; gap: 10px;
                box-shadow: 0 10px 20px -5px rgba(99, 102, 241, 0.4); transition: 0.25s;
            }
...
print("✅ FORM UI BEAUTIFIED: Modern Inputs, Bold Labels & Gradient Buttons!")
