...
print(f"ðŸ”§ Adding Question Paper Setter to: {TARGET_FILE}")

# --- UPDATED EXAMS CODE (With Paper Maker) ---
code_content = r"""import React, { useState } from "react";
import SidebarModern from "../components/SidebarModern";
import { Clock, CheckCircle, FileText, UserCheck, Brain, Plus, Trash, Save, FileOutput, List } from "lucide-react";
import toast, { Toaster } from 'react-hot-toast';

export default function Exams() {
  const [activeTab, setActiveTab] = useState('evaluation'); // 'evaluation' or 'setter'
  ...
  return (
    <div className="exams-container">
        ...
        <div className="main-content">
            ...
            {/* TAB 1: PAPER SETTER (NEW FEATURE) */}
            {activeTab === 'setter' && (
                                ...
                                <tbody>
                                    {questions.map((q, i) => (
                                        <tr key={q.id}>
                                            ...
                                            <td>{q.marks}</td>
                                            <td>
                                                <button onClick={() => deleteQuestion(q.id)} className="icon-btn-danger"><Trash size={16}/></button>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
            ...
            {/* TAB 2: EVALUATION (EXISTING FEATURE) */}
            {activeTab === 'evaluation' && (
                <div className="fade-in">
                    <div className="card shadow-md">
                        <div className="exam-meta-header">
                            <div>
                                <h2 style={{margin:0, fontSize: '1.2rem'}}>Mid-Term Physics (Descriptive)</h2>
                                <div className="tags">
        ...
        <style>{`
            ...
            .form-grid { display: grid; grid-template-columns: 1fr 1fr 1fr 1fr auto; gap: 15px; align-items: center; }
            .full-width { grid-column: span 1; flex: 1; }
            .input-field { padding: 10px; border: 1px solid #cbd5e1; border-radius: 8px; outline: none; }
            ...
            .modern-table th { text-align: left; padding: 12px; color: #64748b; border-bottom: 1px solid #e2e8f0; font-size: 0.9rem; }
            ...
            .icon-btn-danger { background: #fee2e2; color: #ef4444; border: none; padding: 8px; border-radius: 6px; cursor: pointer; }
            ...
            .tags { margin-top: 5px; display: flex; gap: 10px; }
            .meta-tag { background: #f1f5f9; padding: 4px 10px; border-radius: 6px; font-size: 0.8rem; font-weight: 700; color: #475569; }
...
print("✅ SUCCESS: Added 'Paper Setter' Feature to Exams.jsx!")
