...
print(f"ðŸ”§ Fixing Invisible Buttons in Exam Controller: {TARGET_FILE}")

# --- FIXED CODE (Stronger Colors) ---
  ...
  return (
    <div className="exams-container">
                                        ...
                                        <tr key={q.id} className={editingId === q.id ? 'highlight-row' : ''}>
                                            ...
                                            <td>
                                                <div className="action-buttons">
                                                    <button onClick={() => setViewQ(q)} className="icon-btn btn-view" title="View"><Eye size={18}/></button>
                                                    <button onClick={() => handleEditClick(q)} className="icon-btn btn-edit" title="Edit"><Edit2 size={18}/></button>
                                                    <button onClick={() => deleteQuestion(q.id)} className="icon-btn btn-delete" title="Delete"><Trash size={18}/></button>
                                                </div>
                                            </td>
                                        </tr>
                                    ))}
        ...
        <style>{`
            ...
            .icon-btn { border: none; width: 36px; height: 36px; border-radius: 8px; display: flex; alignItems: center; justifyContent: center; cursor: pointer; transition: 0.2s; }
            .btn-view { background: #dbeafe; color: #2563eb; } /* Strong Blue */
            .btn-edit { background: #ffedd5; color: #d97706; } /* Strong Orange */
            .btn-delete { background: #fee2e2; color: #dc2626; } /* Strong Red */
...
print("✅ SUCCESS: Fixed Button Colors (Darker Blue, Orange, Red)!")
