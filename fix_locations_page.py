...
# print(f"ðŸ”§ Fixing Dropdowns, Actions & Adding Delete in: {TARGET_FILE}")
...
#                                                 <button onClick={() => { setViewNode(center); setActiveActionMenu(null); }} className="action-item"><Eye size={14}/> View</button>
#                                                 <button onClick={() => handleEditClick(center)} className="action-item"><Edit size={14}/> Edit</button>
#                                                 {/* ADDED DELETE BUTTON */}
#                                                 <button onClick={() => handleDelete(center.id)} className="action-item delete"><Trash2 size={14}/> Delete</button>
#                                             </div>
#                                         )}
#                                     </td>
#                                 </tr>
...
#                                 <div className="info-item"><MapPin size={18}/><p>{viewNode.address}</p></div>
#                                 <div className="info-item"><Mail size={18}/><p>{viewNode.contact_email}</p></div>
#                             </div>
#                         </div>
...
#                 z-index: 1000; display: flex; flex-direction: column; gap: 4px; min-width: 140px;
#             }
#             .action-item { 
...
# print("✅ LOCATIONS PAGE FIXED: Text Visible, Action Button Fixed, Delete Button Added!")
