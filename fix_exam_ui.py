...
print(f"ðŸ”§ Fixing Exam Controller Input Colors (Removing Black Background): {TARGET_FILE}")
...
export default function Exams() {
  const [activeTab, setActiveTab] = useState('setter'); // Default to setter for demo
  ...
  return (
    <div className="exams-container">
                                ...
                                <tbody>
                                    {questions.map((q, i) => (
                                        <tr key={q.id}>
                                            ...
                                            <td style={{fontWeight: 600, color: '#1e293b'}}>{q.text}</td>
        ...
        <style>{`
            ...
            .btn-primary { background: var(--primary); color: white; border: none; padding: 12px 20px; border-radius: 8px; font-weight: 700; cursor: pointer; }
...
print("✅ SUCCESS: Exam UI Inputs Fixed (Forced White Background & Dark Text)")
