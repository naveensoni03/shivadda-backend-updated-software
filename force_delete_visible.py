  ...
  return (
    <div className="waoo-app-container">
                                    ...
                                    <td style={{textAlign: 'center', position: 'relative'}}>
                                        ...
                                        {activeActionMenu === center.id && (
                                            <div className="action-popup fade-in">
                                                <button onClick={(e) => { e.stopPropagation(); setViewNode(center); setActiveActionMenu(null); }} className="action-item">
                                                    <Eye size={16}/> View
                                                </button>
                                                <button onClick={(e) => { e.stopPropagation(); handleEditClick(center); }} className="action-item">
                                                    <Edit size={16}/> Edit
                                                </button>
        ...
        <style>{`
            ...
            /* --- ACTION POPUP FIXED --- */
            .action-popup { 
                position: absolute; right: 50px; top: -20px; /* Moves it slightly up so it won't get cut off */
                background: white; border-radius: 12px; 
                box-shadow: 0 10px 40px rgba(0,0,0,0.2); 
                border: 1px solid #e2e8f0; padding: 8px; 
                z-index: 10000; display: flex; flex-direction: column; gap: 5px; min-width: 150px;
                height: auto;
            }
            .action-item { 
                background: transparent; border: none; text-align: left; 
                padding: 12px 15px; border-radius: 8px; font-weight: 700; 
                color: #334155; cursor: pointer; display: flex; align-items: center; gap: 10px; font-size: 0.9rem; width: 100%;
            }
            .action-item:hover { background: #eff6ff; color: #3b82f6; }
            /* Explicit Red Color for Delete */
            .action-item.delete { color: #ef4444; border-top: 1px solid #f1f5f9; margin-top: 5px; }
...
print("✅ DELETE BUTTON FORCEFULLY ADDED & VISIBILITY FIXED!")
