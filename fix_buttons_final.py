...
print(f"ðŸ”§ Making Action Buttons Bigger & Bolder: {TARGET_FILE}")

# --- FIXED CODE (Bold Buttons) ---
  ...
  return (
    <div className="exams-container">
                                        ...
                                        <tr key={q.id} className={editingId === q.id ? 'highlight-row' : ''}>
                                            ...
                                            <td>
                                                <div className="action-buttons">
                                                    <button onClick={() => setViewQ(q)} className="icon-btn btn-view" title="View"><Eye size={20}/></button>
                                                    <button onClick={() => handleEditClick(q)} className="icon-btn btn-edit" title="Edit"><Edit2 size={20}/></button>
                                                    <button onClick={() => deleteQuestion(q.id)} className="icon-btn btn-delete" title="Delete"><Trash size={20}/></button>
                                                </div>
                                            </td>
                                        </tr>
                                    ))}
        ...
        <style>{`
            ...
            .btn-view { background: #3b82f6; color: white; } /* Solid Blue */
            .btn-edit { background: #f59e0b; color: white; } /* Solid Orange */
            .btn-delete { background: #ef4444; color: white; } /* Solid Red */
            
            .icon-btn:hover { transform: translateY(-2px); box-shadow: 0 4px 8px rgba(0,0,0,0.2); filter: brightness(1.1); }
...
print("✅ SUCCESS: Action Buttons are now BIG & BOLD (Solid Colors)!")
