...
print(f"ðŸ”§ Applying MASTER FIX (Crash, Pagination, Add Center) in: {TARGET_FILE}")

code_content = r"""import React, { useState, useEffect } from "react";
import SidebarModern from "../components/SidebarModern";
// FIXED: Added missing icons (Server, CheckCircle, Save) to prevent crash
...
export default function Locations() {
  ...
  const totalPages = Math.ceil(centers.length / itemsPerPage) || 1;
  ...
  const handleAddSubmit = () => {
      ...
      toast.success("New Node Onboarded!", {
          icon: 'ðŸš€',
  ...
  return (
    <div className="waoo-app-container">
        ...
        <style>{`
            ...
            /* --- PAGINATION (Always Visible) --- */
            .waoo-pagination-bar { padding: 20px 30px; border-top: 1px solid #f1f5f9; background: #fcfcfc; display: block; }
...
print("✅ MASTER FIX APPLIED: Crash Resolved, Pagination Visible, Add Center & Actions Working!")
