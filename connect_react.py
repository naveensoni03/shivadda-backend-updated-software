...
# --- PATH SETUP ---
BASE_DIR = os.getcwd()
# Adjust path to reach frontend/src/pages/Exams.jsx correctly
...
print(f"ðŸ”§ Connecting Exams.jsx to Django Backend: {TARGET_FILE}")

code_content = r"""import React, { useState, useEffect } from "react";
import SidebarModern from "../components/SidebarModern";
import { Clock, CheckCircle, FileText, UserCheck, Brain, Plus, Trash, Save, FileOutput, Eye, Edit2, X, Sparkles, Zap, ChevronLeft, ChevronRight, RefreshCw } from "lucide-react";
...
export default function Exams() {
  ...
  const [newQ, setNewQ] = useState({ text: "", q_type: "Descriptive", difficulty: "Medium", marks: 5 }); // q_type matches Django model
  ...
  const handleSaveQuestion = async () => {
      ...
      try {
          if (editingId) {
              ...
              setQuestions([res.data, ...questions]); // Add new to top
  ...
  // --- DUMMY EVALUATION DATA (Keep frontend only for now) ---
  ...
  return (
    <div className="exams-container">
        ...
        <div className="main-content">
            ...
            {/* TAB 2 & MODAL REMAIN SAME (Just CSS) */}
            {/* ... Kept existing Evaluation & Modal code ... */}
                        ...
                        <div className="modal-body">
                            ...
                            <div className="grid-details">
                                <div className="detail-row">
                                    ...
                                    <span className="badge">{viewQ.q_type}</span>
                                </div>
                                <div className="detail-row">
...
print("✅ SUCCESS: Frontend is now using Axios to talk to Django!")
