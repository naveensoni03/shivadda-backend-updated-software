...
print(f"ðŸ”§ FIXING INVISIBLE TEXT IN SCHOOL PROFILE MODAL: {TARGET_FILE}")
  ...
  return (
    <div className="waoo-app-container">
        ...
        <style>{`
            ...
            .waoo-input-modern { width: 100%; padding: 16px; background: #f8fafc; border: 2px solid transparent; border-radius: 16px; font-weight: 600; color: var(--text-dark); font-size: 1rem; transition: all 0.25s ease; }
...
print("✅ INSTITUTIONS VIEW MODAL FIXED: Text is now Dark & Visible!")
