  ...
  return (
    <div className="hostel-page-wrapper">
      ...
      <div className="hostel-main-content">
        ...
        {/* --- FIXED: HORIZONTAL SCROLL TABS FOR MOBILE --- */}
                ...
                <div className="luxe-panel slide-in-right" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="panel-content-scroll">
                        <div className="input-group">
                            ...
                            <select style={{width: '100%', padding: '14px', borderRadius: '12px', border: '1px solid #334155', color:'white', background:'#1e293b', outline: 'none', boxSizing: 'border-box'}} value={studentId} onChange={(e) => setStudentId(e.target.value)}>
                                <option value="">-- Choose Student --</option>
                                {studentsList.map(s => <option key={s.id} value={s.id}>{s.name}</option>)}
                            </select>
                        </div>
                        <button className="btn-confirm-gradient hover-lift" onClick={handleAllocate} style={{width: '100%', marginTop:'30px', padding: '16px', borderRadius: '12px'}}>Confirm Allocation</button>
                    </div>
                </div>
            </div>
        )}
