...
export default function Attendance() {
  ...
  // Assuming '1' is the Batch ID for 'Class 10-A'. In real app, fetch batches dynamically.
  ...
  const fetchData = async () => {
    ...
    try {
        ...
        setTimeout(() => setLoading(false), 500); // Keep small delay for smooth transition
    }
  };
  ...
  return (
    <div className="app-container">
                        ...
                        <table className="floating-table">
                            ...
                            <tbody>
                                {students.length > 0 ? students.map((s, idx) => (
                                    ...
                                    <tr><td colSpan="4" style={{textAlign:'center', padding:'20px'}}>No students found for this batch.</td></tr>
                                )}
                            </tbody>
                        </table>
                    </div>
      ...
      <style>{`
        ...
        /* BACKGROUND SHAPES */
        .bg-shape { position: absolute; border-radius: 50%; filter: blur(80px); opacity: 0.6; z-index: 0; }
        ...
        .tab-btn {
            display: flex; alignItems: center; gap: 8px; padding: 10px 20px; border: none; background: transparent;
        ...
        /* TABLE STYLING */
        .floating-table { width: 100%; border-collapse: separate; border-spacing: 0 12px; }
        .floating-table th { 
            text-align: left; padding: 0 20px 10px 20px; color: #94A3B8; font-size: 0.75rem; 
            text-transform: uppercase; letter-spacing: 1px; font-weight: 700; 
        }
        .table-row { 
            background: white; box-shadow: var(--shadow-sm); transition: 0.3s;
        ...
        .avatar { width: 42px; height: 42px; border-radius: 12px; color: white; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 1.1rem; box-shadow: 0 4px 10px rgba(0,0,0,0.1); }
        ...
        .st-btn { 
            width: 38px; height: 38px; border-radius: 10px; border: none; font-weight: 800; cursor: pointer; 
            transition: all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1); color: #94A3B8; background: transparent; font-size: 0.9rem;
        }
        ...
        .insight-card {
            ...
            display: flex; align-items: center; gap: 20px; box-shadow: var(--shadow-sm); transition: 0.3s;
        }
        .insight-card:hover { transform: translateY(-5px); box-shadow: var(--shadow-lg); }
        
        .ic-icon { width: 50px; height: 50px; border-radius: 14px; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; position: relative; z-index: 2; }
        ...
        .filter-btn-pro { 
            ...
            font-weight: 600; color: #475569; display: flex; gap: 8px; cursor: pointer; transition: 0.2s;
        }
        ...
        /* CUSTOM TOAST */
        .glass-toast { 
            background: rgba(255, 255, 255, 0.85); backdrop-filter: blur(12px); border: 1px solid white;
            padding: 15px 20px; border-radius: 20px; display: flex; gap: 15px; box-shadow: 0 20px 50px rgba(0,0,0,0.15);
...
const StatCard = ({ label, value, icon, color, delay }) => {
    ...
    return (
        <div style={{ animation: `scaleIn 0.5s ${delay} backwards` }}>
            <div 
                style={{ 
                    background: theme.bg, 
                    borderRadius: '20px', 
