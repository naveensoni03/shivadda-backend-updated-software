  ...
  return (
    <div className="dashboard-container" style={{background: '#f8fafc', height: '100vh', display: 'flex', overflow: 'hidden'}}>
      ...
      <div className="main-content" style={{flex: 1, padding: '40px', overflowY: 'auto'}}>
        ...
        {/* --- CONTENT AREA --- */}
        <div className="glass-card fade-in-up" style={{background: 'white', padding: '40px', borderRadius: '24px', minHeight: '500px', boxShadow: '0 10px 40px rgba(0,0,0,0.05)'}}>
            ...
            {activeTab === 'general' && (
                <div className="form-section">
                    ...
                    {/* ✅ UPDATED: Upload Buttons with Preview */}
            ...
            {activeTab === 'backup' && (
                <div className="form-section">
                    ...
                    <div style={{background: '#fef2f2', padding: '20px', borderRadius: '12px', border: '1px solid #fecaca'}}>
                        ...
                        <button style={{background: '#dc2626', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '8px', fontWeight: '700', cursor: 'pointer'}}>⚠️ Reset All Data</button>
                    </div>
                </div>
            )}
            ...
            {/* FOOTER SAVE */}
            {activeTab !== 'backup' && (
                <div style={{marginTop: '40px', borderTop: '1px solid #f1f5f9', paddingTop: '20px', textAlign: 'right'}}>
                    <button className="btn-confirm-gradient hover-lift" onClick={handleSave} style={{padding: '12px 30px'}}>
      ...
      <style>{`
        ...
        .grid-2-col { display: grid; grid-template-columns: 1fr 1fr; gap: 25px; margin-bottom: 20px; }
        .grid-3-col { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; margin-bottom: 20px; }
        
        /* Tab Styling */
        .config-tab { background: transparent; border: none; padding: 10px 20px; font-weight: 600; color: #64748b; cursor: pointer; border-radius: 30px; transition: 0.3s; font-size: 0.95rem; }
        ...
        /* UPDATED: Working Upload Box */
        .upload-box { width: 120px; height: 120px; border: 2px dashed #cbd5e1; border-radius: 16px; display: flex; flex-direction: column; align-items: center; justify-content: center; cursor: pointer; transition: 0.3s; color: #64748b; position: relative; overflow: hidden; background: #f8fafc; }
        .upload-box:hover { border-color: #6366f1; color: #6366f1; background: #eef2ff; }

        /* Toggle Switch */
        .toggle-row { display: flex; justify-content: space-between; alignItems: center; padding: 15px 0; border-bottom: 1px solid #f1f5f9; }
        ...
        /* Buttons */
        .btn-confirm-gradient { background: linear-gradient(135deg, #0f172a 0%, #334155 100%); color: white; border: none; border-radius: 12px; font-weight: 700; cursor: pointer; box-shadow: 0 10px 20px rgba(15, 23, 42, 0.15); transition: 0.2s; }
