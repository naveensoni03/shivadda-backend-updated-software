...
export default function Communication() {
  ...
  // ✅ 1. FIXED POLLING LOGIC (Prevents Console Spam on 404)
  useEffect(() => {
        ...
        if (newMsgs && newMsgs.length > 0) {
            ...
            if (!processedMsgIds.current.has(msgUniqueKey)) {
                ...
                setConversations(prev => ({
                    ...prev,
                    1: [...(prev[1] || []), { ...latestMsg, id: Date.now() }] 
                }));
            }
        }
      } catch (error) {
          // Explicitly do nothing so console doesn't spam red errors if endpoint is missing yet.
      }
    }, 5000); 
  ...
  const handleSendMessage = async () => {
    ...
    try {
        ...
        toast.error("SMS Failed (Check Server)");
    } finally {
        setSending(false);
        setMessageInput(""); 
    }
  ...
  return (
    <div className="comm-app">
      ...
      <style>{`
        ...
        .comm-container { 
            flex: 1; margin-left: 280px; padding: 25px; 
            position: relative; z-index: 10; display: flex; flex-direction: column; 
            height: 100vh; overflow-y: auto !important; box-sizing: border-box;
        ...
        @media (max-width: 1024px) {
            .comm-container { margin-left: 0 !important; max-width: 100%; width: 100%; }
        }
        ...
        @media (max-width: 850px) {
            ...
            .comm-container {
                ...
                padding-bottom: 120px !important; /* Prevents chatbot overlap */
